    ...
    <nav class="navbar navbar-inverse" id="nav">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav" id="navUl">
              ...
              <div class='dropdown'><button class='btn btn-primary dropdown-toggle' type='button' data-toggle='dropdown'>Alex<span class="caret"></span></button>
                        <ul class='dropdown-menu'>
                            <li><a class="btn btn-default btn-sm" href="#"><span class="glyphicon glyphicon-log-out"></span> Log out</a></li>
                            <li><a class="btn btn-default btn-sm" href="#"><span class="glyphicon glyphicon-user"></span> User </a></li>
                        </ul>
                    </div>
